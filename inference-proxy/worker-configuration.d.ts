/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1bfc2d71678917f698879c883d5ece45)
// Runtime types generated with workerd@1.20260515.1 2026-05-20 nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	FIREWORKS_API_KEY: string;
	USAGE_COUNTER: DurableObjectNamespace<import("./src/server").UsageCounter>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIREWORKS_API_KEY">> {}
}
